...
| DO-020 Agent Orchestration Layer | [`impl/agent-orchestration-layer/`](impl/agent-orchestration-layer/) | full fan-out/budget/trigger/background-run engine with the real BudgetManager built and tested; executor/ledger/router/control-plane behind interfaces |
| DO-021 Interface Shell | [`impl/interface-shell/`](impl/interface-shell/) | full intent/card/activity/approval/evidence/sidebar projection layer built and tested; engine-free by construction; executor/approval-contract/workspace-store behind interfaces |
